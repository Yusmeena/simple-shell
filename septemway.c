...
/**
 * add_list_to_start - adds a node to the start of the list
 ...
 * Return: size of list
 */
list_t *add_list_to_start(list_t **head, const char *text, int num)
{
	list_t *new_head;
...
/**
 * add_list_to_end - adds a node to the end of the list
 * @head: address of pointer to the head of the list
 * @text: text field of the node
 * @num: list index used by history
 *
 * Return: size of list
 */
list_t *add_list_to_end(list_t **head, const char *text, int num)
{
...
/**
 * print_list_text - prints only the 'txt' element of a list_t linked list
 * @h: pointer to the first node
 *
 * Return: size of list
 */
size_t print_list_text(const list_t *h)
{
	size_t size = 0;
...
/**
 * delete_node_at_index - Remove node at given index
 * @head: First node
